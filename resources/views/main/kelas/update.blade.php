            ...
            <div class="card border-0 shadow-sm overflow-hidden">
                ...
                <div class="card-header bg-transparent pt-4 pb-3 px-4 border-0">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-0">Edit Data Kelas</h5>
                            <p class="text-muted small mb-0">Perbarui informasi kelas <strong class="text-dark">{{ $kelas->nama }}</strong></p>
                        </div>
                    </div>
                </div>

                <div class="card-body px-4 pb-4">
                    <form action="{{ route('kelas.update', $kelas->id) }}" method="POST" id="form">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="grade" id="grade"
                                        ...
                                        @for ($i = 7; $i <= 9; $i++)
                                            <option value="{{ $i }}"
                                                {{ old('grade', $currentGrade) == $i ? 'selected' : '' }}>
                                                Kelas {{ $i }}
                                            </option>
                                        @endfor
                                    </select>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama', $className) }}">
                                    @error('nama')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-text">Nama kelas lengkap: <strong id="preview-nama" class="text-warning">—</strong></div>
                            </div>
                        </div>
