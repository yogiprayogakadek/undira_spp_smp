                ...
                <div class="card-header bg-transparent pt-4 pb-3 px-4 border-0">
                    <div class="d-flex align-items-center gap-3">
                        <div style="width:48px;height:48px;border-radius:14px;background:#eef2ff;display:flex;align-items:center;justify-content:center;">
                            <iconify-icon icon="solar:user-plus-bold-duotone" class="text-primary" style="font-size:24px"></iconify-icon>
                        </div>
                        <div>
                            <h5 class="fw-bold mb-0">Tambah Data Siswa</h5>
                    ...
                    <form action="{{ route('siswa.store') }}" method="POST" id="form">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3">
                            <div style="width:28px;height:28px;border-radius:8px;background:#eef2ff;display:flex;align-items:center;justify-content:center;">
                                <iconify-icon icon="solar:user-id-bold-duotone" class="text-primary" style="font-size:15px"></iconify-icon>
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Nama lengkap siswa" value="{{ old('nama_lengkap') }}">
                                    @error('nama_lengkap')
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nis" name="nis" placeholder="250001" value="{{ old('nis') }}">
                                    @error('nis')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3">
                            <div style="width:28px;height:28px;border-radius:8px;background:#eafaf7;display:flex;align-items:center;justify-content:center;">
                                <iconify-icon icon="solar:buildings-bold-duotone" class="text-success" style="font-size:15px"></iconify-icon>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="no_telp" name="no_telp" placeholder="08xx..." value="{{ old('no_telp') }}">
                                    @error('no_telp')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email"
                                        ...
                                        id="email" name="email" placeholder="siswa@email.com" value="{{ old('email') }}">
                                    @error('email')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
